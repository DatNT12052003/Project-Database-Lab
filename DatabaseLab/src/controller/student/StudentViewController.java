...
public class StudentViewController {
	...
	private void handleOpenHome() throws Exception {
    	Pane scene = FXMLLoader.load(getClass().getResource("/view/student/home/HomeScene.fxml"));
    	mainScene.getChildren().setAll(scene);
	}
	
	@FXML
	private void handleOpenCourses() throws Exception {
    	Pane scene = FXMLLoader.load(getClass().getResource("/view/student/courses/CoursesScene.fxml"));
    	mainScene.getChildren().setAll(scene);
	}
