package controller.student.courses.studying;
...
public class StudyingSceneController {
	...
	public void initialize() {
		courseList = courseDAO.getAllStudyingCoursesByStudentid(UserLogin.getUserid());
	...
	private void addCoursesToGrid(List<Course> courses) {
	    ...
	    for (Course course : courses) {
	        try {
	            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/student/courses/studying/CourseItem.fxml"));
