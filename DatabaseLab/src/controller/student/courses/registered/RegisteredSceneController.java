...
public class RegisteredSceneController {
	...
	public void initialize() {
		courseList = courseDAO.getAllRegisteredCoursesByStudentid(UserLogin.getUserid());
	...
	private void addCoursesToGrid(List<Course> courses) {
	    ...
	    for (Course course : courses) {
	        try {
	            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/student/courses/registered/CourseItem.fxml"));
