package controller.student.courses.registration;
...
public class RegistrationCourseSceneController {
	...
	public void initialize() {
		courseList = courseDAO.getAllCoursesRegistration();
	...
	private void addCoursesToGrid(List<Course> courses) {
	    ...
	    for (Course course : courses) {
	        try {
	            FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/student/courses/registration/CourseItem.fxml"));
