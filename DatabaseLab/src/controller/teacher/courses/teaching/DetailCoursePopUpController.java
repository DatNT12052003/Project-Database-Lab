...
public class DetailCoursePopUpController {
	...
	@FXML
	private TableColumn<Study, Double> averageScoreColumn;
	...
	public void setData(Course courseItem) {
		...
		averageScoreColumn.setStyle("-fx-alignment: CENTER;");
	...
	private void handleRollCall() {
		  try {
		        FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/teacher/courses/teaching/RollCallPopUp.fxml"));
		        Parent root = loader.load();

		        RollCallPopUpController popUpController = loader.getController();
		        
		        popUpController.setData(courseItem);
		        popUpController.setDetailCoursePopUpController(this);
